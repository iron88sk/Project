...
COLORS = {'ma2c': color_cycle[0], 'ia2c': color_cycle[1], 'iqll': color_cycle[2], 
          'base': color_cycle[3], 'greedy':color_cycle[4]}
plot_dir =  'seoul_test2/plots'


def plot_train_curve(scenario='seoul', date='may12'):
    cur_dir = 'seoul_test2/train_data'
    names = ['ma2c', 'iqll']
    labels = ['MA2C',  'IQL-LR']
...
def plot_eval_curve(scenario='seoul', date='dec16'):
    cur_dir = 'seoul_test2/eva_data'
